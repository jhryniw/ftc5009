...
final class Case3blueredredblue extends PathBase{

    Case3blueredredblue(LinearOpMode opMode, Robot r, Coordinate startLoc) {
        super(opMode, r, startLoc, "Case3 blue/red red/blue");
    }
    @Override
