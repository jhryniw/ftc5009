...
final class Case4redbluebluered extends PathBase {

    Case4redbluebluered(LinearOpMode opMode, Robot r, Coordinate startLoc) {
        super(opMode, r, startLoc, "Case4 red/blue blue/red");
    }
