...
final class Case2redblueredblue extends PathBase {

    Case2redblueredblue(LinearOpMode opMode, Robot r, Coordinate startLoc) {
        super(opMode, r, startLoc, "Case2 red/blue red/blue");
    }
